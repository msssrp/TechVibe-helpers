...
export default function Home() {
  ...
  return (
    <div className="bg-gray-200 min-h-screen flex justify-center items-center flex-col">
      ...
      <div className="google-blue text-white hover:text-white bg-[#4285f4] shadow font-bold text-sm py-3 px-4 rounded flex justify-start items-center cursor-pointer w-64">
        ...
        <button onClick={handleGoogle} className="pl-3">Sign up with Google</button>
      </div>
      ...
      <div className="bg-gray-900 text-gray-100 hover:text-white shadow font-bold text-sm py-3 px-4 rounded flex justify-start items-center cursor-pointer w-64 mt-2">
        ...
        <button className="pl-3">Sign up with Github</button>
      </div>
      ...
      <div className="bg-indigo-600 text-gray-100 hover:text-white shadow text-sm font-bold py-3 px-4 rounded flex justify-start items-center cursor-pointer w-64 mt-2">
        <svg viewBox="0 0 24 24" className="fill-current mr-3 w-6 h-6" xmlns="http://www.w3.org/2000/svg"><path d="M23.998 12c0-6.628-5.372-12-11.999-12C5.372 0 0 5.372 0 12c0 5.988 4.388 10.952 10.124 11.852v-8.384H7.078v-3.469h3.046V9.356c0-3.008 1.792-4.669 4.532-4.669 1.313 0 2.686.234 2.686.234v2.953H15.83c-1.49 0-1.955.925-1.955 1.874V12h3.328l-.532 3.469h-2.796v8.384c5.736-.9 10.124-5.864 10.124-11.853z" /></svg>
        <span className="border-l border-indigo-500 h-6 w-1 block mr-1"></span>
        <button className="pl-3">Sign up with Facebook</button>
      </div>
